...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Options/Classes/Slow.js", "./Options/Interfaces/ISlow.js"], factory);
    }
    ...
    async function loadExternalSlowInteraction(engine, refresh = true) {
        await engine.addInteractor("externalSlow", async (container) => {
            const { Slower } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Slower.js"))) : new Promise((resolve_1, reject_1) => { require(["./Slower.js"], resolve_1, reject_1); }).then(__importStar));
