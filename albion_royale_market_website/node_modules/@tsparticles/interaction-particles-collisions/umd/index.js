...
(function (factory) {
    ...
    async function loadParticlesCollisionsInteraction(engine, refresh = true) {
        await engine.addInteractor("particlesCollisions", async (container) => {
            const { Collider } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Collider.js"))) : new Promise((resolve_1, reject_1) => { require(["./Collider.js"], resolve_1, reject_1); }).then(__importStar));
