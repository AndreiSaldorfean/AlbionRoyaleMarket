...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./Options/Classes/Trail.js", "./Options/Interfaces/ITrail.js"], factory);
    }
    ...
    async function loadExternalTrailInteraction(engine, refresh = true) {
        await engine.addInteractor("externalTrail", async (container) => {
            const { TrailMaker } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./TrailMaker.js"))) : new Promise((resolve_1, reject_1) => { require(["./TrailMaker.js"], resolve_1, reject_1); }).then(__importStar));
