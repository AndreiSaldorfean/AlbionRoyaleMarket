...
(function (factory) {
    ...
    async function loadExternalConnectInteraction(engine, refresh = true) {
        await engine.addInteractor("externalConnect", async (container) => {
            const { Connector } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Connector.js"))) : new Promise((resolve_1, reject_1) => { require(["./Connector.js"], resolve_1, reject_1); }).then(__importStar));
