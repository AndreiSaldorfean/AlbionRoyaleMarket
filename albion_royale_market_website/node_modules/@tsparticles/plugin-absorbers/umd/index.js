...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./AbsorberContainer.js", "./Enums/AbsorberClickMode.js"], factory);
    }
    ...
    async function loadAbsorbersPlugin(engine, refresh = true) {
        const { AbsorbersPlugin } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./AbsorbersPlugin.js"))) : new Promise((resolve_1, reject_1) => { require(["./AbsorbersPlugin.js"], resolve_1, reject_1); }).then(__importStar));
