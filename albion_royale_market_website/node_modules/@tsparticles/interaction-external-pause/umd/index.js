...
(function (factory) {
    ...
    async function loadExternalPauseInteraction(engine, refresh = true) {
        await engine.addInteractor("externalPause", async (container) => {
            const { Pauser } = await (__syncRequire ? Promise.resolve().then(() => __importStar(require("./Pauser.js"))) : new Promise((resolve_1, reject_1) => { require(["./Pauser.js"], resolve_1, reject_1); }).then(__importStar));
